...
import { CHAT_ERROR, FETCH_CONVERSATIONS, FETCH_RECIPIENTS, START_CONVERSATION, SEND_REPLY, FETCH_SINGLE_CONVERSATION, FETCH_MYPROFILE} from './types';
...
export function fetchMyProfile() {
  ...
  return dispatch => getData(FETCH_MYPROFILE, MYPROFILE_ERROR, true, url, dispatch);
}
