...
export function updateProfile({ emailQuery, firstName, email, age, age_pref_min, age_pref_max }) {
  return function (dispatch) {
    axios.put(`${API_URL}/user/update`, { emailQuery, firstName, email, age, age_pref_min, age_pref_max }, { headers: { Authorization: cookie.load('token') } })
      .then((response) => {
